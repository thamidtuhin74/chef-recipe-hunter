...
const AboutUs = () => {
    return (
        <div className='mycontainer max-h-[1867px] flex md:flex-row xsm:flex-col-reverse xsm:p-4 md:gap-[134px] !my-[85px]'>
            {/* md:w-1/2 sm:w-full */}
            ...
            <div className='md:w-1/2 align-middle'>
                ...
                <hr className='w-[117px] pb-[2px] h-[2px] bg-[#E6E600] mb-[25px]'/>
