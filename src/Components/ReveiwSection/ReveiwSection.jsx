        ...
        <div className='bg-[url("/src/assets/reviewBG.png")] bg-cover h-[auto]'>
            ...
            {/* md:px-[100px] xsm:px[50px] */}
                <div className='max-w-[995px] px-[30px] lg:px[100px] mx-auto !text-center'>
                    ...
                    <p className='paragraph !text-[#fff] mt-[26px] text-center'>chicken is one of the wholesome foods that man can eat in fact people have been eating chicken throughout human</p>
