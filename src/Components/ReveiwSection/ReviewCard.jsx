    ...
    return (
        <div className='grid  grid-cols-1 md:grid-cols-3 gap-[30px]'>
            ...
            <div className='bg-[#fff] rounded-[20px] p-[30px] flex flex-col items-center'>
                ...
                <img src="https://i.ibb.co/THNDjd6/buyer1.png" alt="" className='w-[120px] h-[120px] rounded-[50%]'/>
            ...
            <div className='bg-[#fff] rounded-[20px] p-[30px] flex flex-col items-center'>
                <img src="https://i.ibb.co/9g8HVWY/buyer2.png" alt="" className='w-[120px] h-[120px] rounded-[50%]'/>
                <div className="star flex flex-row font-[18px] text-[#007500] my-[24px]">
                    <FaStar className='w-[18px] h-[18px]'/>
                    <FaStar className='w-[18px] h-[18px] mx-[8px]'/>
                    <FaStar className='w-[18px] h-[18px]'/>
                ...
                <p className='paragraph pb-[24px]'>it is a longestablished fact that a reader will be distracted by the readable content od the a page</p>
                <h2 className='title !text-black'>dina deep</h2>
            </div>

            <div className='bg-[#fff] rounded-[20px] p-[30px] flex flex-col items-center'>
                <img src="https://i.ibb.co/r4fmVJD/buyer3.png" alt="" className='w-[120px] h-[120px] rounded-[50%]'/>
                <div className="star flex flex-row font-[18px] text-[#007500] my-[24px]">
                    <FaStar className='w-[18px] h-[18px]'/>
                    <FaStar className='w-[18px] h-[18px] mx-[8px]'/>
                    <FaStar className='w-[18px] h-[18px]'/>
                ...
                <h2 className='title !text-black'>devid jay</h2>
            </div>
        </div>
    );
};
